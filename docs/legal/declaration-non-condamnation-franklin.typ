// ============================================================================
//  DÉCLARATION DE NON-CONDAMNATION ET DE FILIATION — Franklin TRANIÉ
// ============================================================================
...
#set page(
  ...
  footer: context {
    ...
    v(4pt)
    align(center)[
      #text(style: "italic")[#cofounder-first #cofounder-last]
    ]
  },
)
...
Je soussigné *#cofounder-first #cofounder-last*,
...
#block(
  ...
  #grid(
    ...
    column-gutter: 12pt,
    row-gutter: 10pt,
    text(weight: "bold", fill: secondary)[Né le], [#cofounder-birthdate],
    text(weight: "bold", fill: secondary)[À], [#cofounder-birthplace],
    text(weight: "bold", fill: secondary)[Fils de], [Jean-Pascal TRANIÉ],
    text(weight: "bold", fill: secondary)[Et de], [Loraine DONNEDIEU DE VABRES],
    text(weight: "bold", fill: secondary)[Demeurant au], [#cofounder-address],
  )
]
...
#align(right)[
  *#cofounder-first #cofounder-last*
]
