...
A red screen doesn't mean your refund is denied. It means a human needs to look at it.

**Common triggers:**

**Random inspection.** Customs selects a percentage of forms for manual verification. You didn't do anything wrong.
...
**Already at the gate or on the plane?** The form cannot be validated. Contact your refund operator directly. Some operators can extend the deadline if you have a valid reason, but there's no guarantee.
