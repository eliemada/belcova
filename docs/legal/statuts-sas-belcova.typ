...
#page(header: none, footer: none)[
  ...
  Les présents statuts sont établis en vue de la constitution d'une Société par Actions Simplifiée, conformément aux dispositions des articles L. 227-1 à L. 227-20 du Code de commerce.

  La société développe une plateforme web pour les commerçants français et européens et une application mobile pour les voyageurs internationaux, dédiées à la gestion dématérialisée des formalités douanières et fiscales liées aux ventes à l'exportation.

  #v(0.5cm)

  #note-box[
    Les présents statuts prévoient l'entrée d'associés (business angels, fonds d'investissement) et la mise en place d'instruments d'intéressement (BSPCE, BSA, actions gratuites). Un *pacte d'associés* signé le *#date-document* organise les relations entre les Associés Fondateurs (sortie conjointe, entraînement, _vesting_, droits protecteurs, confidentialité, non-concurrence, résolution des blocages).
  ]
...
Le capital social est fixé à la somme de *#capital-initial euros* (#capital-initial €), divisé en *#nb-actions actions* de *#valeur-nominale euro* de valeur nominale chacune, réparties en deux catégories, entièrement souscrites et intégralement libérées, réparties comme suit :
...
Toute augmentation ou réduction du capital social est décidée par la collectivité des associés statuant dans les conditions de majorité requises pour les décisions extraordinaires, conformément aux dispositions légales en vigueur.

Chaque associé bénéficie d'un *droit préférentiel de souscription* proportionnel à sa participation, exerçable dans un délai de *#delai-preemption-exercice jours* à compter de la notification du projet d'augmentation. L'admission de tout nouvel associé par voie de souscription est en outre soumise à la *procédure d'agrément* prévue aux présents statuts.
