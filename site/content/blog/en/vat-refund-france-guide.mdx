...
You need to spend at least **€100.01 (TTC)** at a single store on the same day. With traditional operators, split a €200 trip across two stores and neither receipt qualifies. Belcova aggregates purchases across partner stores, so two €100 receipts combine into one eligible claim.
...
1. **Consolidate when you can.** Buy everything you can at one store in one visit. Two €80 purchases at the same store, same day = one €160 purchase. With Belcova, purchases across different partner stores also aggregate toward the €100.01 threshold.
