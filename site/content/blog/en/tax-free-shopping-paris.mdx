...
**Splitting purchases across stores.** Two €80 purchases at two different stores each fall below the €100.01 minimum. With a traditional operator, both refunds are lost. Belcova aggregates your purchases across partner stores, so those two €80 receipts combine into one €160 claim that qualifies.
